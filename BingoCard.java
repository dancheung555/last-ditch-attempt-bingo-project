...
public class BingoCard {
	...
	public BingoCard() {
		ID++;
		seedRand = BingoCardTextFrame.getSeed();
		createRandom(seedRand+ID);
	...
	public void setBanks0(ArrayList<Integer> arr) {
		banks0 = arr;
	}
	public void setBanks1(ArrayList<Integer> arr) {
		banks1 = arr;
	}
	public void setBanks2(ArrayList<Integer> arr) {
		banks2 = arr;
	}
	public void setBanks3(ArrayList<Integer> arr) {
		banks3 = arr;
	}
	public void setBanks4(ArrayList<Integer> arr) {
		banks4 = arr;
	}
