...
public class BingoPanelMultiple extends JPanel implements KeyListener, MouseListener, ActionListener {
	...
	public BingoPanelMultiple() {
		super();
		BingoCard x = new BingoCard();
		card = x.getArr();
		
		try {
            template = ImageIO.read(BingoPanelMultiple.class.getResource("/BingoTemplate.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
		setSize(1100, 900);
